...
class ViewController: UIViewController, SideBarDelegate, UIPageViewControllerDataSource, UINavigationControllerDelegate, NSFetchedResultsControllerDelegate {
